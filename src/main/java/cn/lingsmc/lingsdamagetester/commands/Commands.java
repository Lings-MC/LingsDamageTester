package cn.lingsmc.lingsdamagetester.commands;

import cn.lingsmc.lingsdamagetester.commands.subcommands.HelpCommand;
import cn.lingsmc.lingsdamagetester.commands.subcommands.OffCommand;
import cn.lingsmc.lingsdamagetester.commands.subcommands.OnCommand;
import cn.lingsmc.lingsdamagetester.commands.subcommands.ReloadCommand;
import cn.lingsmc.lingsdamagetester.commands.subcommands.StatusCommand;
import cn.lingsmc.lingsdamagetester.commands.subcommands.ToggleCommand;
import cn.lingsmc.lingsdamagetester.constants.MessageConstants;
import cn.lingsmc.lingsdamagetester.utils.StringUtils;
...
import static cn.lingsmc.lingsdamagetester.constants.CommandConstants.*;
import static cn.lingsmc.lingsdamagetester.constants.MessageConstants.UNKNOWN_COMMAND;
...
public class Commands implements CommandExecutor, TabCompleter {
    ...
    private void registerCommand(String commandName, SubCommand subCommand) {
        if (getCOMMAND_MAP().containsKey(commandName)) {
            Bukkit.getLogger().warning("[LingsDamageTester] 子命令 " + commandName + " 已注册，跳过重复注册.");
            return;
        }
